...
if (!empty($_GET['token'])) {
  $Read = new Read;
  $Read->FullRead("SELECT * FROM members WHERE mem_tokenrecovery = '{$_GET['token']}'");
  if (!$Read->getResult()) {
    echo 'Token Invalido';
    return;
  }
                ...
                <form id="RecoverToken" role="form">
                  ...
                  <div class="form-group mb-3">
                    <div class="input-group input-group-merge input-group-alternative">
                      ...
                      <input name="mem_password" class="form-control" placeholder="Nova Senha" type="password">
                    </div>
                  </div>
                  <div class="form-group mb-3">
                    <div class="input-group input-group-merge input-group-alternative">
                ...
                <form id="Recover" role="form">
                  <div class="form-group mb-3">
                    <div class="input-group input-group-merge input-group-alternative">
                      ...
                      <input name="mem_email" class="form-control" placeholder="Qual seu Email?" type="email">
                    </div>
                  </div>
                  <div class="text-center">
